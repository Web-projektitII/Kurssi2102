...
.radio {display:inline;padding-right:4px;padding-left:4px;white-space:nowrap;}
.yksikko {padding-left:8px;}
.teksti {display:inline-block;width:200px;}
.lukema {display:inline-block;width:50px;}
.ul-flex-row {flex-direction:row;flex-wrap:wrap;}
.virhe_p {color:red;}
...
echo "<select name=\"language_id\" class=\"form-control\" style=\"display:inline-block;width:200px;\">";
...
foreach ($strArr AS $feature){
  ...
  echo "<label class=\"label-cb\">$f</label><span class=\"tyhja\"></span><input type=\"checkbox\" name=\"special_features[]\" 
...
echo "<ul class=\"list-group ul-flex-row\">";
