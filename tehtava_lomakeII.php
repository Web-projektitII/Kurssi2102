...
<form class="needs-validation" novalidate id="action_form" action="tehtava_lomakekasittelija.php" method="post" enctype="multipart/form-data" onsubmit="validate_jquery();">
<fieldset>
...
<div class="form-group row">
<label class="control-label col-sm-2">Kieli:</label>
<span class="<?php virhe('language_id');?>">*</span>
<div class="col-sm-10">
<?php echo kielet();?>
...
<input type="file" class="form-control-file" style="display:inline-block;width:75%;" id="logo" name="logo">
</div>

<div class="form-group row">
<div class="col-sm-offset-2 col-sm-10">
<input class="btn btn-primary" type="submit" name="painike" value="Tallenna"><br>
</div></div>
</fieldset>
